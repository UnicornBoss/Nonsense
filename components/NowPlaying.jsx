...
function AnimatedBars() {
  ...
  return (
    <div className="w-auto flex items-end overflow-hidden">
      <span
        id="bar1"
        className="w-1 mr-[3px] h-2 bg-green-600 dark:bg-green-800 opacity-75"
      />
      <span
        id="bar2"
        className="w-1 mr-[3px] h-1 bg-green-600 dark:bg-green-800"
      />
      <span
        id="bar3"
        className="w-1 h-3 bg-green-600 dark:bg-green-800 opacity-80"
      />
    </div>
  );
}
